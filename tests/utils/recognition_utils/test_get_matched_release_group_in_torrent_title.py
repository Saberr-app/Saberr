...
CASES = [
    ...
    Case(id="subsplus",
         ...
         expected_name="SubsPlus+"),
    Case(id="toonshub",
         title="[ToonsHub] The Cat and the Dragon S01E12 1080p CR WEB-DL AAC2.0 H.264 (Neko to Ryuu, Multi-Subs)",
         expected_name="ToonsHub"),
    Case(id="varyg contains filter",
         title="One Piece S01E1177 1080p NF WEB-DL AAC2.0 H.264-VARYG (Multi-Subs)",
         expected_name="VARYG"),
    Case(id="varyg contains filter is case-insensitive",
         title="One Piece S01E1177 1080p NF WEB-DL AAC2.0 H.264-varyg (Multi-Subs)",
         expected_name="VARYG"),
